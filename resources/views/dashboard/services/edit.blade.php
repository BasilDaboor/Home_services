                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('dashboard.services.update', $service) }}" method="POST">
                        ...
                        <div class="flex items-center justify-between mt-6">
                            <a href="{{ route('dashboard.services.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                Cancel
                            </a>

                        ...
                        <form action="{{ route('dashboard.bookings.index') }}" method="GET"
                            ...
                            <div class="flex-1">
                                <input type="text" name="search" value="{{ request('search') }}"
                                    placeholder="Search users, providers or services..."
                            ...
                            <button type="submit"
                                class="px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-md">Filter</button>
                            <a href="{{ route('dashboard.bookings.index') }}"
                                class="px-4 py-2 bg-gray-300 hover:bg-gray-400 rounded-md">Reset</a>
                        </form>
                    </div>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @forelse ($bookings as $booking)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="py-3 px-4">
                                            {{ $booking->user->first_name . ' ' . $booking->user->last_name }}</td>
                                        <td class="py-3 px-4">
                                        ...
                                        <td class="py-3 px-4">
                                            <span
                                                ...
                                                @elseif($booking->status == 'completed') bg-green-100 text-green-800 @endif">

        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('dashboard.bookings.edit', $booking) }}"
                    class="px-4 py-2 bg-yellow-600 hover:bg-yellow-700 rounded-md text-white">Edit</a>
                <a href="{{ route('dashboard.bookings.index') }}"
                    class="px-4 py-2 bg-gray-600 hover:bg-gray-700 rounded-md text-white">Back to List</a>
            </div>
        </div>
    </x-slot>
    <div class="py-12">
                    ...
                    <div class="bg-gray-50 rounded-lg shadow p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
                            ...
                            <div>
                                ...
                                <div class="mt-2 bg-white p-4 rounded-md border">
                                    <p class="font-medium">
                                        {{ $booking->provider->user->first_name . ' ' . $booking->provider->user->first_name }}
                                    </p>
                                </div>
                            </div>
